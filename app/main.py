...
from app.food.complaints.router import router as food_complaint_router
from app.food.complaints.service import ensure_schema as ensure_food_complaint_schema
...
app.include_router(food_complaint_router)
